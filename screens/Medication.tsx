                                        ...
                                        <MedicationButton onPress={() => navigation.navigate({name: 'SingleMedication', params: {meds: medic}})} >
                                            <View style={{flexDirection: 'row'}}>
                                                ...
                                                <View style={{flexDirection: 'column', paddingHorizontal: 14}}>
                                                    <Text style={[{fontSize: 14, paddingVertical: 7}]}>{medic.name}</Text>
                                                    <Text style={[styles.text2, {fontSize: 12, width: '150%', paddingBottom: 5}]}>{medic.prescription}{medic.howOften != null? ', '+ t('every')+ ' '+parseInt(medic.howOften.toString().split(':')[0], 10)+t('text24') : ''}</Text>
                                                </View>
                                            </View>
